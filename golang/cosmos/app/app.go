...
func upgradePriceFeedCoreProposalSteps(upgradeName string) ([]vm.CoreProposalStep, error) {
	...
	switch upgradeName {
	case "agoric-upgrade-16-a3p-integration":
		entrypoint = "deprecatedPriceFeedProposalBuilder"
	case "agoric-upgrade-16-main":
	...
	switch upgradeName {
	case "agoric-upgrade-16-a3p-integration", "agoric-upgrade-16-main":
		inBrands = []BrandInfo{
			{"ATOM", "ATOM"},
			{"stATOM", "stAtom"},
			{"stOSMO", "stOSMO"},
