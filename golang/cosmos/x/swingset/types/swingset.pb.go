...
type Params struct {
	...
	// Map from phase name to a slow-deletion budget limit.
	// Must not be negative.
	//
	// These values are used by SwingSet to rate-limit the deletion of
	// previously-terminated vats. Each empty block is allowed to
	// delete a few DB entries
	//
	// There is no required order to this list of entries, but all the chain
	// nodes must all serialize and deserialize the existing order without
	// permuting it.
	SlowDeletionBudget []StringBudget `protobuf:"bytes,6,rep,name=slow_deletion_budget,json=slowDeletionBudget,proto3" json:"slow_deletion_budget"`
}
...
func (m *Params) GetSlowDeletionBudget() []StringBudget {
	if m != nil {
		return m.SlowDeletionBudget
	}
	return nil
}
...
// Map element of a string key to a Nat budget count.
type StringBudget struct {
	// Which phase of slow vat cleanup the budget is for
	Key string `protobuf:"bytes,1,opt,name=key,proto3" json:"key,omitempty"`
	// The budget value.
	Budget github_com_cosmos_cosmos_sdk_types.Uint `protobuf:"bytes,2,opt,name=budget,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Uint" json:"budget"`
}

func (m *StringBudget) Reset()         { *m = StringBudget{} }
func (m *StringBudget) String() string { return proto.CompactTextString(m) }
func (*StringBudget) ProtoMessage()    {}
func (*StringBudget) Descriptor() ([]byte, []int) {
	return fileDescriptor_ff9c341e0de15f8b, []int{7}
}
func (m *StringBudget) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *StringBudget) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_StringBudget.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *StringBudget) XXX_Merge(src proto.Message) {
	xxx_messageInfo_StringBudget.Merge(m, src)
}
func (m *StringBudget) XXX_Size() int {
	return m.Size()
}
func (m *StringBudget) XXX_DiscardUnknown() {
	xxx_messageInfo_StringBudget.DiscardUnknown(m)
}

var xxx_messageInfo_StringBudget proto.InternalMessageInfo

func (m *StringBudget) GetKey() string {
	if m != nil {
		return m.Key
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*StringBudget)(nil), "agoric.swingset.StringBudget")
...
var fileDescriptor_ff9c341e0de15f8b = []byte{
	...
	,
}
...
func (this *Params) Equal(that interface{}) bool {
	...
	if len(this.SlowDeletionBudget) != len(that1.SlowDeletionBudget) {
		return false
	}
	for i := range this.SlowDeletionBudget {
		if !this.SlowDeletionBudget[i].Equal(&that1.SlowDeletionBudget[i]) {
			return false
		}
	}
	return true
...
func (this *StringBudget) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*StringBudget)
	if !ok {
		that2, ok := that.(StringBudget)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.Budget.Equal(that1.Budget) {
		return false
	}
	return true
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.SlowDeletionBudget) > 0 {
		for iNdEx := len(m.SlowDeletionBudget) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.SlowDeletionBudget[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *StringBudget) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *StringBudget) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *StringBudget) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Params) Size() (n int) {
	...
	if len(m.SlowDeletionBudget) > 0 {
		for _, e := range m.SlowDeletionBudget {
			l = e.Size()
			n += 1 + l + sovSwingset(uint64(l))
		}
	}
...
func (m *StringBudget) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SlowDeletionBudget", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SlowDeletionBudget = append(m.SlowDeletionBudget, StringBudget{})
			if err := m.SlowDeletionBudget[len(m.SlowDeletionBudget)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *StringBudget) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: StringBudget: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: StringBudget: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
