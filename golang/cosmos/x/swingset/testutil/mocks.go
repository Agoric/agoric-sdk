...
func (mr *MockVstorageKeeperMockRecorder) GetChildren(ctx, path interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockVstorageKeeperMockRecorder) GetEntry(ctx, path interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockVstorageKeeperMockRecorder) GetQueueLength(ctx, path interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockVstorageKeeperMockRecorder) HasEntry(ctx, path interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockVstorageKeeperMockRecorder) LegacySetStorageAndNotify(ctx, entry interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockVstorageKeeperMockRecorder) PathToEncodedKey(path interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockVstorageKeeperMockRecorder) PushQueueItem(ctx, path, value interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockVstorageKeeperMockRecorder) SetStorage(ctx, entry interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockSwingSetKeeperMockRecorder) ChargeBeans(ctx, beansPerUnit, addr, beans interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockSwingSetKeeperMockRecorder) ChargeForSmartWallet(ctx, beansPerUnit, addr interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockSwingSetKeeperMockRecorder) GetBeansPerUnit(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockSwingSetKeeperMockRecorder) GetSmartWalletState(ctx, addr interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockSwingSetKeeperMockRecorder) IsHighPriorityAddress(ctx, addr interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
