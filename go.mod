...
replace (
	...
	github.com/cosmos/cosmos-sdk => github.com/agoric-labs/cosmos-sdk v0.45.5-alpha.agoric.2
	// github.com/cosmos/cosmos-sdk => ../forks/cosmos-sdk

	github.com/cosmos/gaia/v6 => github.com/Agoric/ag0/v6 v6.0.3-alpha.agoric.1

	// Fork for glob allowlist in ica-host
	github.com/cosmos/ibc-go/v3 => github.com/agoric-labs/ibc-go/v3 v3.1.0-alpha.agoric.1
	// github.com/cosmos/ibc-go => ../forks/ibc-go
