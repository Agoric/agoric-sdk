...
require (
	...
	github.com/cosmos/interchain-accounts v0.0.0-20220223134510-470336f44c70
...
replace github.com/cosmos/cosmos-sdk => github.com/agoric-labs/cosmos-sdk v0.45.1-alpha.agoric.4
