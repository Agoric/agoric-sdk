...
const {lineBreak} = require('acorn/src/whitespace');
...
function plugin(options, Parser) {
  return class extends Parser {
    parseSubscript(base, startPos, startLoc, noCalls, maybeAsyncArrow) {
      ...
      return super(base, startPos, startLoc, noCalls, maybeAsyncArrow);
    }

    parseMaybeUnary(refDestructuringErrors, sawUnary) {
      const node = super(refDestructuringErrors, sawUnary);
