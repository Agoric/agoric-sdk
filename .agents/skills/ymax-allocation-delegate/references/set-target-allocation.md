...
## Preconditions
- Onboarding and delegation complete, ideally via the one-step UI deep link in `agent-onboarding.md`.
...
- Authorization failures: do not blind-retry; re-check the deep-link onboarding flow, granted permissions, and delegated address first.
...
- Authorization/delegation failure: delegate not authorized for this portfolio, missing required permission, or wrong delegated address.
