git clone https://github.com/AgoricBot/SwingSet.git
cd SwingSet
git remote add upstream https://github.com/Agoric/SwingSet.git
git remote set-url origin https://AgoricBot:$GITHUB_TOKEN@github.com/AgoricBot/SwingSet.git
git fetch upstream
git checkout master
...
if [ "$files_changed" = true ]; then
  ...
  hub pull-request --no-edit --base Agoric/SwingSet:master
fi
