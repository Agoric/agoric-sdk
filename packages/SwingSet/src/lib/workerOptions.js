 ...
 * @param {import('../controller/bundle-handler.js').BundleHandler} bundleHandler
 * @param {string[]} [nodeOptions]
 * @returns {Promise<import("../types-internal.js").WorkerOptions>}
 */
...
/**
 * @param {import('../types-internal.js').WorkerOptions} origWorkerOptions
 * @param {{bundleHandler: import("../controller/bundle-handler.js").BundleHandler}} options
 * @returns {Promise<import("../types-internal.js").WorkerOptions>}
 */
