...
/** @typedef {(vatId: any, originalSyscall: VatSyscallObject, newSyscall: VatSyscallObject, originalResponse: VatSyscallResult) => CompareSyscallsResult | Promise<CompareSyscallsResult>} CompareSyscalls */
...
export function makeTranscriptManager(
  ...
  function simulateSyscall(newSyscall) {
     ...
     * @returns {VatSyscallResult | undefined | Promise<VatSyscallResult | undefined>}
     */
