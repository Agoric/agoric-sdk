...
export function makeVatLoader(stuff) {
   ...
   *   dynamic vat; if false, it's a static vat (these have differences in their
   *   allowed options and some of their option defaults).
   * @param {SourceOfBundle} details.source an object which either has a
   *   `bundle` (JSON-serializable data), a `bundleName` string, or a `bundleID`
   *   string. The bundle defines the vat, and should be generated by calling
