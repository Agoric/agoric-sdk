...
export function makeVirtualObjectManager(
   ...
   */
  function defineKindInternal(tag, init, actualize, durable) {
    ...
    function makeNewInstance(...args) {
      ...
      const initialRepresentative = makeRepresentative(innerSelf, true, false);
  ...
  function defineKind(tag, init, actualize) {
    return defineKindInternal(tag, init, actualize, false);
  }

  function defineDurableKind(tag, init, actualize) {
    return defineKindInternal(tag, init, actualize, true);
  }
