 ...
 * @typedef {LocalWorkerOptions
 *   | XSnapWorkerOptions
 *   | NodeSubprocessWorkerOptions} WorkerOptions
 *
 ...
 * @property {MeterID} [meterID] // property must be present, but can be
 *   undefined
 ...
 * ) => Promise<SnapshotResult>} MakeSnapshot
 *
 * @typedef {{
 *   deliver: (
 *     delivery: VatDeliveryObject,
 *     vatSyscallHandler: VatSyscallHandler,
 ...
 * @typedef {[
 *   tag: 'initialize-worker',
 *   options: TranscriptDeliveryInitializeWorkerOptions,
 ...
 *   | TranscriptDeliveryShutdownWorker} TranscriptDelivery
 ...
 * @typedef {TranscriptDeliverySaveSnapshotResults
 *   | TranscriptDeliveryGenericResults} TranscriptDeliveryResults
 * @typedef {{
 *   d: TranscriptDelivery;
 *   sc: TranscriptSyscall[];
 *   r: TranscriptDeliveryResults;
 * }} TranscriptEntry
 */
