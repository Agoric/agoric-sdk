 ...
 */
const makeVStorage = (powers, config) => {
  /** @param {string} path */
  const getJSON = path => {
 ...
 */
const makeAgoricNames = async (ctx, vstorage) => {
  const reverse = {};
