...
test('admin price', async t => {
  ...
  /** @type {import('@agoric/zoe/src/zoeService/utils.js').Instance<import('@agoric/zoe/src/contracts/priceAggregator.js').start>} */
  ...
  /** @type {import('@agoric/zoe/src/contracts/priceAggregator.js').PriceRound} */
