...
const setupServices = async (
  ...
  // @ts-expect-error auctionKit.creatorFacet looks right.
  await E(auctionKit.creatorFacet).addBrand(aeth.issuer, 'Aeth');
...
test('price falls precipitously', async t => {
  ...
  console.log(`TVL precip `, vfPublic, vaultFactory);
