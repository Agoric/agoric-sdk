 ...
 * @property {Ratio}         liquidationMargin       - margin below which
 *   collateral will be liquidated to satisfy the debt.
 * @property {Ratio}         liquidationPenalty      - penalty charged upon
 *   liquidation as proportion of debt
 * @property {Ratio}         stabilityFee            - annual interest rate
 ...
 * @property {Ratio}         [liquidationPadding]    - vault must maintain this
 *   in order to remove collateral or add debt
 */
 ...
 * @property {() => Ratio}               getStabilityFee      - The annual
 *   interest rate on a debt position
 * @property {() => RelativeTime}        getChargingPeriod    - The period (in
 *   seconds) at which interest is charged to the debt position.
 * @property {() => RelativeTime}        getRecordingPeriod   - The period (in
 *   seconds) at which interest is recorded to the debt position.
 */
 ...
 * @property {NatValue}  interest                 interest accrued since
 *   latestStabilityFeeUpdate
 * @property {NatValue}  newDebt                  total including principal and
 *   interest
 */
 ...
 * @property {Calculate} calculate                calculate new debt for
 *   charging periods up to the present.
