...
const compoundAddresses = harden({
  ...
  testnet: {
    ...
    Polygon: '0xF09F0369aB0a875254fB565E52226c88f10Bc839', // https://docs.compound.finance/#networks -> Polygon Mumbai Testnet -> cUSDCv3 contract
    Arbitrum: '0x',
    Optimism: '0x',
  },
});
...
const beefyVaultAddresses = harden({
  ...
  convexMim: {
    mainnet: {
      // https://github.com/beefyfinance/beefy-v2/blob/9216cb622aa788668bfc40040b7e17ceb941ecfd/src/config/vault/ethereum.json#L6497
      // https://app.beefy.com/vault/convex-mim
      Ethereum: '0xd5bAd7c89028B3F7094e40DcCe83D4e6b3Fd9AA4',
    },
    testnet: {},
  },
  balancerv3: {
    mainnet: {
      // https://github.com/beefyfinance/beefy-v2/blob/9216cb622aa788668bfc40040b7e17ceb941ecfd/src/config/vault/ethereum.json#L1317
      Ethereum: '0x0C57F1e8F2A02485DE8b69C59c7be61B473cA25a',
    },
    testnet: {},
  },
  curveUsdcUsdf: {
    mainnet: {
      // https://github.com/beefyfinance/beefy-v2/blob/9216cb622aa788668bfc40040b7e17ceb941ecfd/src/config/vault/ethereum.json#L819
      Ethereum: '0x0014E0be19De3118b5b29842dd1696a2A98EB9Db',
    },
    testnet: {},
  },
  spellMimCrv: {
    mainnet: {
      // https://github.com/beefyfinance/beefy-v2/blob/9216cb622aa788668bfc40040b7e17ceb941ecfd/src/config/vault/arbitrum.json#L19911
      Arbitrum: '0xDa2307A45D298e855415675bF388e2bd64351D5b',
    },
    testnet: {},
  },
});
...
const factoryAddresses = harden({
  mainnet: {
    ...
    // TODO: Deploy and replace with correct Factory address on Ethereum mainnet
...
const mainnetContracts = {
  ...
  Ethereum: {
    ...
    Beefy_curveUsdcUsdf_Ethereum:
      beefyVaultAddresses.curveUsdcUsdf.mainnet.Ethereum,
    Beefy_convexMim_Ethereum: beefyVaultAddresses.convexMim.mainnet.Ethereum,
    Beefy_balancerv3_Ethereum: beefyVaultAddresses.balancerv3.mainnet.Ethereum,
    Beefy_spellMimCrv_Arbitrum:
      beefyVaultAddresses.spellMimCrv.mainnet.Arbitrum,
  },
  Optimism: {
