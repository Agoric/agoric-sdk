...
> See also board marshalling conventions (_to appear_).
    ...
    [
      ...
      [
        'published.agoricNames.chain.Arbitrum.axelarId',
        {
          id: 'arbitrum-sepolia',
        },
      ],
      [
        'published.agoricNames.chain.Arbitrum.contracts',
        {
      ...
      [
        'published.agoricNames.chain.Avalanche.axelarId',
        {
          id: 'Avalanche',
        },
      ],
      [
        'published.agoricNames.chain.Avalanche.contracts',
        {
      ...
      [
        'published.agoricNames.chain.Binance',
        {
          namespace: 'eip155',
          reference: '56',
        },
      ...
      [
        'published.agoricNames.chain.Binance.axelarId',
        {
          id: 'binance',
        },
      ],
      [
        'published.agoricNames.chain.Binance.contracts',
        {
          aavePool: '0x',
          compound: '0x',
          factory: '0x',
      ...
      [
        'published.agoricNames.chain.Ethereum.axelarId',
        {
          id: 'ethereum-sepolia',
        },
      ],
      [
        'published.agoricNames.chain.Ethereum.contracts',
        {
      ...
      [
        'published.agoricNames.chain.Fantom',
        {
          namespace: 'eip155',
          reference: '250',
        },
      ...
      [
        'published.agoricNames.chain.Fantom.axelarId',
        {
          id: 'Fantom',
        },
      ],
      [
        'published.agoricNames.chain.Fantom.contracts',
        {
          aavePool: '0x',
          compound: '0x',
          factory: '0x',
      ...
      [
        'published.agoricNames.chain.Optimism.axelarId',
        {
          id: 'optimism-sepolia',
        },
      ],
      [
        'published.agoricNames.chain.Optimism.contracts',
        {
      ...
      [
        'published.agoricNames.chain.Polygon.axelarId',
        {
          id: 'polygon-sepolia',
        },
      ],
      [
        'published.agoricNames.chain.Polygon.contracts',
        {
          aavePool: '0x',
          compound: '0x',
          factory: '0x',
