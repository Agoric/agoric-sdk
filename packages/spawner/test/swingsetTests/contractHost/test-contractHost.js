...
test.skip('run contractHost Demo --alice-first without SES', async t => {
...
test.skip('run contractHost Demo --bob-first without SES', async t => {
...
test.skip('run contractHost Demo --covered-call without SES', async t => {
...
test.skip('run contractHost Demo --covered-call-sale without SES', async t => {
