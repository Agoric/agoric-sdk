 ...
 * virtual: BOOL, // true=>vref designates a "merely virtual" object (not
 * durable, not ephemeral) durable: BOOL, // designates a durable (not merely
 * virtual, not ephemeral) }
 *
 * A vref string can take one of the forms:
 *
 * T-N T+N T+DN/I T+DN/I:F
 *
 * Where:
 *
 ...
 * 'device', 'object', or 'promise' is returned as the `type` property of the
 * result.
 *
 ...
 *
 * D is the durability status: for object exports ("o+"), this will be the
 * letter 'd' for durable objects, the letter 'v' for non-durable ("merely
 * virtual") objects, or empty for "Remotable" (ephemeral) objects. It is empty
 * for object imports ("o-"), and both both imports and exports of all other
 ...
 *
 * The `baseRef` property of the result is `vref` stripped of any facet
 * indicator.
 *
 ...
 * a faceted object it is the cohort record as a whole rather than any
 * particular individual facet.
 *
 ...
 * @param {boolean} allocatedByVat Flag: true=>vat allocated, false=>kernel
 *   allocated
...
export function makeBaseRef(kindID, id, isDurable) {
