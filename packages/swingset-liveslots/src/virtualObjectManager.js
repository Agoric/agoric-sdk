...
export const makeVirtualObjectManager = (
  ...
  /** @type {import('./vatDataTypes.js').VatData['defineKind']} */
  ...
  /** @type {import('./vatDataTypes.js').VatData['defineKindMulti']} */
  ...
  /** @type {import('./vatDataTypes.js').VatData['defineDurableKind']} */
  ...
  /** @type {import('./vatDataTypes.js').VatData['defineDurableKindMulti']} */
