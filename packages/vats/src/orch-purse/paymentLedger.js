...
import { AmountMath, BrandI } from '@agoric/ertp';
import { preparePaymentKind } from '@agoric/ertp/src/payment.js';

import { prepareOrchPurseKind } from './purse.js';
import { makeOrchIssuerInterfaces } from './typeGuards.js';

/**
 * @import {ShutdownWithFailure} from '@agoric/swingset-vat'
 * @import {TypedPattern} from '@agoric/internal';
 *
 * @import {Amount, AssetKind, DisplayInfo, PaymentLedger, Payment, Brand, RecoverySetsOption, Purse, Issuer, Mint} from '@agoric/ertp'
 * @import {AmountStore} from '@agoric/ertp/src/amountStore.js'
 */
...
export const preparePaymentLedger = (
  ...
  } = makeOrchIssuerInterfaces(brand, assetKind, amountShape);
  ...
  const makeEmptyPurse = prepareOrchPurseKind(
    issuerZone,
    name,
    assetKind,
    brand,
