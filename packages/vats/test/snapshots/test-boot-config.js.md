...
> Snapshot 1
    ...
    "space_bridgeManager" [label="bridgeManager", shape=house, style=filled, fillcolor=khaki];␊
    "space_provisionBridgeChannel" [label="provisionBridgeChannel", shape=house, style=filled, fillcolor=khaki];␊
    "space_provisionWalletBridgeChannel" [label="provisionWalletBridgeChannel", shape=house, style=filled, fillcolor=khaki];␊
    "space_walletBridgeChannel" [label="walletBridgeChannel", shape=house, style=filled, fillcolor=khaki];␊
    ...
    "makeBridgeManager" -> "space_provisionBridgeChannel" []␊
    "makeBridgeManager" -> "space_provisionWalletBridgeChannel" []␊
    "makeBridgeManager" -> "space_walletBridgeChannel" []␊
    ...
    "bridgeProvisioner" -> "space_provisionBridgeChannel" [dir=back]␊
    "bridgeProvisioner" -> "space_provisionWalletBridgeChannel" [dir=back]␊
