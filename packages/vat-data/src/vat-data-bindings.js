 ...
 *
 * `provide` should only to be used to populate baggage, where the total number
 * of calls to `provide` must be low cardinality, since we keep the bookkeeping
 * to detect collisions in normal language-heap memory. All the other
