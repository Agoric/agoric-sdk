 ...
 * @property {() => Denom} getSendDenom get the remote denomination identifier
 *   we send
 */

/**
 * @typedef {object} BoardDepositFacet a registry for depositAddresses
 * @property {(id: string) => any} getValue return the corresponding
 *   DepositFacet
 */
 ...
 * @property {string} [sender] the sender address attached to the packet to
 *   receive any refund
 */
