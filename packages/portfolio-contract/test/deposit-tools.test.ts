...
test('planDepositTransfers works in a handful of cases', t => {
  ...
  const targetAllocation1 = { USDN: 50, Aave: 30, Compound: 20 };
  
  const result1 = planDepositTransfers(deposit1, currentBalances1, targetAllocation1);
  ...
  const result2 = planDepositTransfers(deposit2, currentBalances2, targetAllocation2);
  ...
  const result3 = planDepositTransfers(deposit3, currentBalances3, targetAllocation3);
  ...
  const result4 = planDepositTransfers(deposit4, currentBalances4, targetAllocation4);
  ...
  const result5 = planDepositTransfers(deposit5, currentBalances5, targetAllocation5);
