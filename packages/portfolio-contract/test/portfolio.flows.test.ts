    ...
    async getChain(name: string) {
      ...
      const it = harden({
        ...
        async makeAccount() {
          ...
          const account = {
            makeProgressTracker(initialReport: ProgressReport = {}) {
              return makeProgressTracker(initialReport);
            },
            getAddress() {
              return addr;
            },
            ...
            async transfer(
              address,
              amount,
              opts: { progressTracker?: ProgressTracker; memo?: string } = {},
            ) {
            ...
            async executeEncodedTx(
              ...
              /** @type {ProgressTracker | undefined} */
              const progressTracker = opts?.progressTracker;
              if (progressTracker) {
