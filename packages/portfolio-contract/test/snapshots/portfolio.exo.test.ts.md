...
> PortfolioStateShape: changes are limited to adding optional properties

    {
      ...
      delegations: Object @match:or {
        payload: [
          ...
          Object @match:splitRecord {
            payload: [
              {
                activeClients: Object @match:remotable {
                  payload: {
                    label: 'activeDelegationClientsStore',
                  },
                },
                statusById: Object @match:remotable {
                  payload: {
                    label: 'delegationStatusStore',
                  },
                },
              },
              {},
      ...
      sourceAccountId: Object @match:or {
        payload: [
          Object @match:kind {
            payload: 'undefined',
          },
