# Snapshot report for `test/portfolio.contract.core.test.ts`

The actual snapshot is saved in `portfolio.contract.core.test.ts.snap`.
...
> baggage after open with positions

    {
      ...
      contract: {
        ...
        instrumentOracle: {
          InstrumentOracle_kindHandle: 'Alleged: kind',
          currentInstrumentOracle: {},
          instrumentOracleGeneration: {
            current: 0,
          },
          instrumentOracleSingleton: 'Alleged: InstrumentOracle',
          latestByPool: {},
          revocable: {
            InstrumentOracle_caretaker_kindHandle: 'Alleged: kind',
          },
        },
        orchestration: {
          executePlan: {
