...
## open portfolio from Arbitrum, 1000 USDC deposit (legacy)
...
## open portfolio from Arbitrum, 1000 USDC deposit (routed)
      ...
      'orchtest.portfolios.portfolio0': {
        ...
        accountStateByChain: {
          Arbitrum: {
            ...
            chainId: 'eip155:42161',
            router: '0x4028686122Ae547e6B551C85962C5dA52db69743',
            state: 'active',
          },
          agoric: {
            address: 'agoric1qyqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqc09z0g',
    ...
    [
      [
        'published.pendingTxs.tx0',
        {
          ...
          details: {
            ...
            expectedRemoteAddress: '0x7F649a200382A9b909989168A7fF5a87B8aea189',
          ...
          payloadHash: '0x69b6ed82886627af9daa64b024aa5dc2e5f2dc8d5bf5a53a7ac34edef2383269',
          sourceAddress: 'cosmos:agoric-3:agoric1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqp7zqht',
          status: 'success',
          type: 'ROUTED_GMP',
        },
      ...
      [
        'published.pendingTxs.tx2',
        {
          destinationAddress: 'eip155:42161:0x4028686122Ae547e6B551C85962C5dA52db69743',
          details: {
            expectedRemoteAddress: '0xa45f3d479e06a242fa1984b0a926b94759267b39',
            instructionSelector: '0x01d34c8a',
            instructionType: 'RemoteAccountExecute',
          },
          payloadHash: '0xc870e925f8788cfbc062f2cf482077ebb707abe506f2d15822cca5c86511e8e8',
          sourceAddress: 'cosmos:agoric-3:agoric1qyqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqc09z0g',
          status: 'success',
          type: 'ROUTED_GMP',
        },
      ...
      [
        'published.pendingTxs.tx4',
        {
          ...
          payloadHash: '0xb6fd12605205b8916e73120ba86eeff6de078af266a74b4476f75a3c985c980a',
          sourceAddress: 'cosmos:agoric-3:agoric1qyqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqc09z0g',
          status: 'success',
          type: 'ROUTED_GMP',
        },
...
## evmHandler.withdraw starts a withdraw flow (legacy)
...
## evmHandler.withdraw starts a withdraw flow (routed)
    ...
    [
      [
        'published.pendingTxs.tx0',
        {
          ...
          payloadHash: '0xed6e663a09ec7b1a7e64baefe3583ca0cfb8edecede8fbcc33afac60c347400d',
          sourceAddress: 'cosmos:agoric-3:agoric1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqp7zqht',
          status: 'success',
          type: 'ROUTED_GMP',
        },
      ...
      [
        'published.pendingTxs.tx2',
        {
          ...
          payloadHash: '0xa11267961a28fbbe469cdc51243e8d5a7fcdc7e04a2fafe6ae426d8904bc8af0',
          sourceAddress: 'cosmos:agoric-3:agoric1qyqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqc09z0g',
          status: 'success',
          type: 'ROUTED_GMP',
        },
...
## evmHandler.deposit (existing Arbitrum) completes a deposit flow (legacy)
...
## evmHandler.deposit (existing Arbitrum) completes a deposit flow (routed)
    ...
    [
      ...
      [
        'published.pendingTxs.tx4',
        {
          ...
          payloadHash: '0x70e5ed8366705fcc808c9a1eeb15ed9dded49a290126bc13376ad49575d34c28',
          sourceAddress: 'cosmos:agoric-3:agoric1qyqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqc09z0g',
          status: 'success',
          type: 'ROUTED_GMP',
        },
...
## evmHandler.deposit (Arbitrum -> Base) completes a deposit flow (legacy)
...
## evmHandler.deposit (Arbitrum -> Base) completes a deposit flow (routed)
    ...
    [
      ...
      [
        'published.pendingTxs.tx4',
        {
          ...
          payloadHash: '0x1dd8a5ac50472031b2a87827f54fc0298c812f69ab1a38b5936b03bfe48015cf',
          sourceAddress: 'cosmos:agoric-3:agoric1qyqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqc09z0g',
          status: 'success',
          type: 'ROUTED_GMP',
        },
      ...
      [
        'published.pendingTxs.tx6',
        {
          ...
          payloadHash: '0x5f8a3fbfd768b644e8f81ce210eb8e29cf5bcac377d7c1df7416b41a3d6ad4dd',
          sourceAddress: 'cosmos:agoric-3:agoric1qyqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqc09z0g',
          status: 'success',
          type: 'ROUTED_GMP',
        },
      ...
      [
        'published.pendingTxs.tx8',
        {
          ...
          payloadHash: '0xed292252a246b0426bd9b64d6187c4616a901444e5a48a5ba8f4e3b68631253d',
          sourceAddress: 'cosmos:agoric-3:agoric1qyqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqc09z0g',
          status: 'success',
          type: 'ROUTED_GMP',
        },
...
## evmHandler.rebalance with target allocation sets allocation and starts a rebalance flow (legacy)
...
## evmHandler.rebalance with target allocation sets allocation and starts a rebalance flow (routed)
...
## evmHandler.rebalance without target allocation uses existing allocation (legacy)
...
## evmHandler.rebalance without target allocation uses existing allocation (routed)
    ...
    [
      [
        'published.pendingTxs.tx0',
        {
          ...
          payloadHash: '0x76416018d9d5c5695eeb77711bfb40172de82ddbf8c141fa12708609c2858b32',
          sourceAddress: 'cosmos:agoric-3:agoric1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqp7zqht',
          status: 'failed',
          type: 'ROUTED_GMP',
        },
    ...
    [
      ...
      [
        'published.pendingTxs.tx10',
        {
          ...
          payloadHash: '0xe4e5fd008232cd1b33a219fa2c7029cf7279cf515a5ae74041f00471fd973301',
          sourceAddress: 'cosmos:agoric-3:agoric1qyqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqc09z0g',
          status: 'success',
          type: 'ROUTED_GMP',
        },
      ...
      [
        'published.pendingTxs.tx13',
        {
          ...
          payloadHash: '0xcc263ae5550d331408aafd61ff659e81460c59d82655b8c83891d7fa214f0c15',
          sourceAddress: 'cosmos:agoric-3:agoric1qyqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqc09z0g',
          status: 'success',
          type: 'ROUTED_GMP',
        },
      ...
      [
        'published.pendingTxs.tx14',
        {
          ...
          payloadHash: '0xce3da35dc69d05e2c53c5512a06883043baafe24de907a01d5df364f1f8dde12',
          sourceAddress: 'cosmos:agoric-3:agoric1qyqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqc09z0g',
          status: 'success',
          type: 'ROUTED_GMP',
        },
      ...
      [
        'published.pendingTxs.tx6',
        {
          ...
          payloadHash: '0xdb08181eecc3faeb0b44a3264d43a0af8d958782c50f635277881016828eafaa',
          sourceAddress: 'cosmos:agoric-3:agoric1qyqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqc09z0g',
          status: 'success',
          type: 'ROUTED_GMP',
        },
