...
## claim rewards on Morpho ERC4626 position successfully
...
> vstorage

    {
      ...
      'orchtest.portfolios.portfolio0.flows.flow1': [
        ...
        {
          error: 'ERC4626 pool key "ERC4626_morphoGauntletUsdcRwa_Ethereum" not found in addresses',
          how: 'ERC4626',
          next: undefined,
          state: 'fail',
          step: 4,
      ...
      'orchtest.portfolios.portfolio0.positions.ERC4626_morphoGauntletUsdcRwa_Ethereum': {
        accountId: 'eip155:1:0x5ea5b8bba287da59b100e85c6c5ec982e6f528ff',
        protocol: 'ERC4626',
        totalIn: {
          brand: Object @Alleged: USDC brand {},
...
> See also board marshalling conventions (_to appear_).
    ...
    [
      ...
      [
        ...
        {
          amount: 3333330000n,
          destinationAddress: 'eip155:1:0x5ea5b8bba287da59b100e85c6c5ec982e6f528ff',
          status: 'success',
          type: 'CCTP_TO_EVM',
        },
      ],
