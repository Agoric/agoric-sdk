...
## open a portfolio with Yearn Ethereum position
...
> vstorage

    {
      ...
      'orchtest.portfolios.portfolio0.positions.Yearn_usdc_Ethereum': {
        accountId: 'eip155:42161:0x126cf3AC9ea12794Ff50f56727C7C66E26D9C092',
        netTransfers: {
          brand: Object @Alleged: USDC brand {},
          value: 3333330000n,
...
## Withdraw from a Yearn Ethereum position
...
## open a portfolio with Yearn Polygon position
...

    {
      ...
      'orchtest.portfolios.portfolio0.flows.flow1': [
        ...
        },
        {
          ...
          dest: 'eip155:137:0x126cf3AC9ea12794Ff50f56727C7C66E26D9C092',
          how: 'CCTP',
          src: 'cosmos:noble-1:cosmos1test',
          step: 3,
        },
      ...
      'orchtest.portfolios.portfolio0.positions.Yearn_usdc_Polygon': {
...
## Withdraw from a Yearn Polygon position
