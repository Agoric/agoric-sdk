...
test('computePartialOrder - sequential chain', t => {
  ...
  //   1: @B -> @C (100)
  //   2: @C -> @D (100)
  // Expected: full sequential dependency
...
test('computePartialOrder - partial initial supply', t => {
  ...
  // Expected: step 1 depends on step 0 (even though @Noble has some supply)
  ...
  t.deepEqual(
    order,
    [[1, [0]]],
    'step 1 depends on step 0 because initial supply (30) < required (100)',
  );
});
