 ...
 * XXX Should we extend AmountMath to better support compare/sort?
 * ```
 * AmountMath.compare(a, b); // -1 | 0 | 1 | NaN
 * AmountMath.sort(records, { by: record => record.amount, direction })
 * ```
 */
