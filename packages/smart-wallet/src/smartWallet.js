 ...
 *     [offerId: string, publicTopics: { [subscriberName: string]: string }]
 *   >;
 *   liveOffers: Array<
 *     [import('./offers.js').OfferId, import('./offers.js').OfferStatus]
 *   >;
 * }} CurrentWalletRecord
 */
 ...
 *
 *   - `brandPurses` is precious and closely held. defined as late as possible to
 *       reduce its scope.
  ...
  const makeWalletWithResolvedStorageNodes = prepareExoClassKit(
    ...
    initState,
    {
      helper: {
         ...
         *
         * We current support only one NameHub, agoricNames, and hence one purse
         * per brand. But we store an array of them to facilitate a transition
         * to decentralized introductions.
         *
         * @param {Brand} brand
