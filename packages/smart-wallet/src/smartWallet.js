      ...
      offers: {
        ...
        async executeOffer(offerSpec) {
          ...
          const executor = makeOfferExecutor({
            ...
            /** @type {(offerId: string, invitationAmount: Amount<'set'>, invitationMakers: import('./types').InvitationMakers, publicSubscribers?: import('./types').PublicSubscribers | import('@agoric/zoe/src/contractSupport').TopicsRecord<any>) => Promise<void>} */
