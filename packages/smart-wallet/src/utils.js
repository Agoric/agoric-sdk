...
export const makeWalletStateCoalescer = (invitationBrand = undefined) => {
  /** @type {Map<import('./smartWallet.js').OfferId, import('./offerWatcher.js').OfferStatus>} */
   ...
   *
   * @type {Map<import('./smartWallet.js').OfferId, { acceptedIn: import('./smartWallet.js').OfferId, description: string, instance: Instance }>}
   */
