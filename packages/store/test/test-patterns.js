...
const matchTests = harden([
  ...
  },
  {
    ...
    noPatterns: [
      ...
      [M.bagOf(M.boolean()), 'bag keys[0]: string "b" - Must be a boolean'],
      [M.bagOf('b'), 'bag keys[1]: "a" - Must be: "b"'],
      [M.bagOf(M.any(), M.gt(5n)), 'bag counts[0]: "[3n]" - Must be > "[5n]"'],
      [M.bagOf(M.any(), M.gt(2n)), 'bag counts[1]: "[2n]" - Must be > "[2n]"'],
    ],
  },
  {
