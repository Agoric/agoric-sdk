...
## issuer
    ...
    ␊
      ...
      makeSystemExternalStore('payment', () => ({}), _init => _data =>␊
    ...
    ␊
      const { makeInstance: makeDepositFacet } = makeSystemExternalStore(␊
      'depositFacet',␊
    ␊
    ␊
    ␊
    ␊
      purse => ({ purse }), /**␊
                             ...
                             */_init2 => _data2 => Remotable(makeInterface(allegedName, ERTPKind.DEPOSIT_FACET), undefined, { receive: _data2.purse.deposit }));␊
    ␊
    ␊
      const {␊
