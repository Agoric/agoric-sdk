...
const makePatternKit = () => {
  ...
  const M = harden({
    ...
    key: () => patt(makeTagged('match:key', undefined)),
    pattern: () => patt(makeTagged('match:pattern', undefined)),
    ...
    split: (base, rest = undefined) =>
      patt(
        makeTagged('match:split', rest === undefined ? [base] : [base, rest]),
      ),
    partial: (base, rest = undefined) =>
      patt(
        makeTagged('match:partial', rest === undefined ? [base] : [base, rest]),
      ),
  });
