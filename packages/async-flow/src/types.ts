...
import type { Fulfilled, Promissory, Vow, VowTools } from '@agoric/vow';
import type { StopRecursion } from '@agoric/internal';
 ...
 */
export type HostOf<F extends CallableFunction> =
