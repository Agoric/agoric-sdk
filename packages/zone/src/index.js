 ...
 * @property {typeof alwaysOnce} once
 * call no more that once per subZone,key pair during any vat incarnation. First
 * such incarnation creates the value that all will then use.
 *
