...
echo  >,expected
is $(xsvatter 3<,in 4>&1) "1:.,hi" "$name"
...
is "$(xsvatter 3<,in 4>&1)" "1:.,1:.,boot" "$name"
okx [ -f ,hello.xss ]
...
is "$(xsvatter -r ,hello.xss 3<,in 4>&1)" "1:.,onMessage is a function" "$name"

name="read transcript and deliver"
echo '6:d12345,' >,in
is "$(xsvatter -r ,hello.xss 3<,in 4>&1)" "1:.,msg len: 5" "$name"
...
is "$(xsvatter -r ,hello.xss 3<,in 4>&1)" "4:?123,1:.,7" "$name"
