...
clean:
	rm -rf $(BUILD_DIR)/bin/$(PLATFORM)/debug/$(NAME)
	rm -rf $(BUILD_DIR)/bin/$(PLATFORM)/release/$(NAME)
	rm -rf $(BUILD_DIR)/tmp/$(PLATFORM)/debug/$(NAME)
	rm -rf $(BUILD_DIR)/tmp/$(PLATFORM)/release/$(NAME)
