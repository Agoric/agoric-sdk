...
/**
 * @deprecated Use `subscribeLatest` from `@agoric/notifier/subscribe.js`
 *   instead.
 *
 *   Adaptor from a notifierP to an async iterable. The notifierP can be any
 *   object that has an eventually invocable `getUpdateSince` method that
 *   behaves according to the notifier spec. This can be a notifier, a promise
 *   for a local or remote notifier, or a presence of a remote notifier.
 *
 ...
 *   result. An iteration result is a record with `value` and `done`
 *   properties.
 *
