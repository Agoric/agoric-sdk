 ...
 * @property {ERef<import('@agoric/time/src/types.js').TimerService>} timer
 * @property {import('@agoric/time/src/types.js').RelativeTime} [quoteInterval]
...
export async function makeFakePriceAuthority(options) {
  ...
  /**
   * @type {NotifierRecord<import('@agoric/time/src/types.js').Timestamp>}
   ...
   * @param {import('@agoric/time/src/types.js').Timestamp} quoteTime
   * @returns {PriceQuote}
   */
  ...
  /** @type { [when: import('@agoric/time/src/types.js').Timestamp, resolve: (quote: PriceQuote) => void][] } */
  let timeClients = [];
