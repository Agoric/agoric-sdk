/**
 * @typedef {Notifier<import('@agoric/time/src/types.js').TimestampRecord>} PeriodNotifier
 *
 ...
 *
 * @property {import('@agoric/time/src/types.js').RelativeTime} interestPeriod
 *
 ...
 * @property {import('@agoric/time/src/types.js').Timestamp} basetime The starting point from which to calculate
 * interest.
 */
 ...
 *
 * @property {() => import('@agoric/time/src/types.js').Timestamp} getLastCalculationTimestamp
 *
