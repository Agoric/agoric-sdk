...
import { calcWinnerAndClose } from './firstPriceLogic.js';
 ...
 * the creator of the contract instance. The first price rule is
 * followed, so the highest bidder pays the amount bid by the
 * highest bidder.
