 ...
 * @returns {StoreMap<Brand, Amount>} sumsByBrand - a map of Brand keys and
 ...
 *
 * @param  {StoreMap<Brand, Amount>} leftSumsByBrand - a map of brands to sums
 * @param  {StoreMap<Brand, Amount>} rightSumsByBrand - a map of brands to sums
 */
