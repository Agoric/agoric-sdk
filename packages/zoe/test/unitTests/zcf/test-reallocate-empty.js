...
test(`zcf.reallocate introducing new empty amount`, async t => {
  ...
  zcfSeat1.decrementBy(harden({ IST: empty }));
  ...
  zcfSeat1.incrementBy(harden({ IST: empty }));
  zcfSeat2.incrementBy(harden({ IST: empty }));
