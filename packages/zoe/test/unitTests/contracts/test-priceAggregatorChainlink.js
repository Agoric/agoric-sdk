...
const aggregatorPath = `${__dirname}/../../../src/contracts/priceAggregatorChainlink`;
...
test('basic', /** @param {ExecutionContext} t */ async t => {
  ...
  await E(pricePushAdminA).pushResult(1, '100');
  await E(pricePushAdminB).pushResult(1, '200');
  await E(pricePushAdminC).pushResult(1, '300');
  await oracleTimer.tick();
  ...
  await oracleTimer.tick();
  await E(pricePushAdminA).pushResult(2, '1000');
  await E(pricePushAdminB).pushResult(2, '2000');
  await E(pricePushAdminC).pushResult(2, '3000');
  await oracleTimer.tick();
  ...
  await oracleTimer.tick();
  await E(pricePushAdminC).pushResult(3, '5000');
  await E(pricePushAdminA).pushResult(3, '4000');
  await E(pricePushAdminB).pushResult(3, '6000');
  await oracleTimer.tick();
...
test('timeout', /** @param {ExecutionContext} t */ async t => {
  ...
  await E(pricePushAdminC).pushResult(3, '1000');
  await E(pricePushAdminA).pushResult(3, '3000');
...
test('issue check', /** @param {ExecutionContext} t */ async t => {
  ...
  await oracleTimer.tick();
  await E(pricePushAdminA).pushResult(1, '50'); // should be IGNORED
  await oracleTimer.tick();
  await E(pricePushAdminB).pushResult(1, '200');
  await oracleTimer.tick();
  await E(pricePushAdminC).pushResult(1, '300');
  ...
  await oracleTimer.tick();
  await E(pricePushAdminB).pushResult(2, '20000');
  await E(pricePushAdminC).pushResult(2, '1000');
  await E(pricePushAdminA).pushResult(2, '3000');
  await oracleTimer.tick();
...
test('supersede', /** @param {ExecutionContext} t */ async t => {
  ...
  await oracleTimer.tick();
  await E(pricePushAdminA).pushResult(1, '100');
  await E(pricePushAdminC).pushResult(2, '300');
  await E(pricePushAdminB).pushResult(1, '200');
  await oracleTimer.tick();
  ...
  await oracleTimer.tick();
  await E(pricePushAdminC).pushResult(4, '1000');
...
test('interleaved', /** @param {ExecutionContext} t */ async t => {
  ...
  await E(pricePushAdminA).pushResult(2, '1000');
  await oracleTimer.tick();
  await E(pricePushAdminC).pushResult(3, '9000');
  await oracleTimer.tick();
  await E(pricePushAdminC).pushResult(2, '3000'); // assumes oracle C is going for a resubmission
  await oracleTimer.tick();
  await oracleTimer.tick();
  await E(pricePushAdminA).pushResult(3, '5000');
  await oracleTimer.tick();
  ...
  await E(pricePushAdminA).pushResult(4, '4000');
  await E(pricePushAdminB).pushResult(4, '5000');
  await E(pricePushAdminC).pushResult(4, '6000');
  ...
  await E(pricePushAdminC).pushResult(5, '1000');
  await oracleTimer.tick();
  await oracleTimer.tick();
  await oracleTimer.tick();
  await oracleTimer.tick();
  ...
  await oracleTimer.tick();
  await oracleTimer.tick();
  await E(pricePushAdminA).pushResult(6, '1000');
  await oracleTimer.tick();
  await oracleTimer.tick();
  await oracleTimer.tick();
  await oracleTimer.tick();
  await oracleTimer.tick();
  await oracleTimer.tick();
  await E(pricePushAdminC).pushResult(7, '1000');
...
test('larger', /** @param {ExecutionContext} t */ async t => {
  ...
  await E(pricePushAdminC).pushResult(2, '1000');
  await oracleTimer.tick();
  await E(pricePushAdminD).pushResult(3, '3000');
  await oracleTimer.tick();
  await oracleTimer.tick();
  await oracleTimer.tick();
  await E(pricePushAdminE).pushResult(1, '300');
  ...
  await oracleTimer.tick();
  await E(pricePushAdminB).pushResult(2, '600');
  await oracleTimer.tick();
  await E(pricePushAdminA).pushResult(2, '500');
  await oracleTimer.tick();
  await E(pricePushAdminC).pushResult(3, '1000');
  await oracleTimer.tick();
  await E(pricePushAdminD).pushResult(1, '500');
  await oracleTimer.tick();
  await oracleTimer.tick();
  await oracleTimer.tick();
  await E(pricePushAdminC).pushResult(2, '1000');
  await oracleTimer.tick();
  await E(pricePushAdminC).pushResult(1, '700'); // this should be IGNORED since oracle C has already sent round 2
...
test('suggest', /** @param {ExecutionContext} t */ async t => {
  ...
  await oracleTimer.tick();
  await E(pricePushAdminB).pushResult(2, '1000');
  ...
  await oracleTimer.tick();
  await E(pricePushAdminA).pushResult(2, '2000');
  await oracleTimer.tick();
  await oracleTimer.tick();
  await E(pricePushAdminC).pushResult(2, '3000');
  ...
  t.deepEqual(oracleASuggestion.startedAt, 0); // round 3 hasn't yet started, so it should be zeroed
});
