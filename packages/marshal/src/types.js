 ...
 *   "copyArray" | "copyRecord" | "copySet" | "copyMap" | "remotable" |
 *   "copyError" | "promise" | "patternNode"
 * } PassStyle
 */
 ...
 *      "boolean" | "number" | "bigint" | "string" | "symbol"),
 *    * the pass-by-copy containers ("copyArray" | "copyRecord" |
 *      "copySet" | "copyMap") that contain other Passables,
 *    * and the special cases ("copyError" | "patternNode"), which
 ...
 *
 * A Passable is a Comparable when it contains only
 ...
 *
 * A Passable is a Pattern when it contains only
 *    * pass-by-copy primitives,
 *    * pass-by-copy containers,
 *    * remotables,
 *    * patternNodes
 *
 * A Pattern can *match* a Passable. Every Comparable is a Pattern that
 ...
 *
 * A Comparable is OnlyData when its pass-by-copy superstructure has no
