...
/**
 * The PassStylePlugs are only used to make a `passStyleOf` function.
 * Thus, it should not depend on an ambient one. Rather, each plug should be
 ...
 * definitely not be valid for any of the other plugs.
 * `remainingAssertValid` still needs to be called to determine if it
 * actually is valid.
 *
