...
import { getSupervisorBundle, supervisorBundleSHA256 } from '../src/index.js';
...
test('bundle hash', async t => {
  ...
  t.is(sha256(encode(bundleString)), supervisorBundleSHA256);
  ...
  t.is(sha256(encode(bundleString2)), supervisorBundleSHA256);
});
