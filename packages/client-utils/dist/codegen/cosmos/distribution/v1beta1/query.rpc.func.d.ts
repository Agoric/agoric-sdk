 ...
 */
export declare const getValidatorDistributionInfo: (client: import("@agoric/cosmic-proto/codegen/helper-func-types.js").EndpointOrRpc, request: QueryValidatorDistributionInfoRequest) => Promise<QueryValidatorDistributionInfoResponse>;
/**
 ...
 */
export declare const getValidatorOutstandingRewards: (client: import("@agoric/cosmic-proto/codegen/helper-func-types.js").EndpointOrRpc, request: QueryValidatorOutstandingRewardsRequest) => Promise<QueryValidatorOutstandingRewardsResponse>;
/**
 ...
 */
export declare const getValidatorCommission: (client: import("@agoric/cosmic-proto/codegen/helper-func-types.js").EndpointOrRpc, request: QueryValidatorCommissionRequest) => Promise<QueryValidatorCommissionResponse>;
/**
 ...
 */
export declare const getValidatorSlashes: (client: import("@agoric/cosmic-proto/codegen/helper-func-types.js").EndpointOrRpc, request: QueryValidatorSlashesRequest) => Promise<QueryValidatorSlashesResponse>;
/**
 ...
 */
export declare const getDelegationRewards: (client: import("@agoric/cosmic-proto/codegen/helper-func-types.js").EndpointOrRpc, request: QueryDelegationRewardsRequest) => Promise<QueryDelegationRewardsResponse>;
/**
 ...
 */
export declare const getDelegationTotalRewards: (client: import("@agoric/cosmic-proto/codegen/helper-func-types.js").EndpointOrRpc, request: QueryDelegationTotalRewardsRequest) => Promise<QueryDelegationTotalRewardsResponse>;
/**
 ...
 */
export declare const getDelegatorWithdrawAddress: (client: import("@agoric/cosmic-proto/codegen/helper-func-types.js").EndpointOrRpc, request: QueryDelegatorWithdrawAddressRequest) => Promise<QueryDelegatorWithdrawAddressResponse>;
/**
 ...
 */
export declare const getCommunityPool: (client: import("@agoric/cosmic-proto/codegen/helper-func-types.js").EndpointOrRpc, request: QueryCommunityPoolRequest) => Promise<QueryCommunityPoolResponse>;
