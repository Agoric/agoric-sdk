 ...
 */
export declare const getCurrentPlan: (client: import("@agoric/cosmic-proto/codegen/helper-func-types.js").EndpointOrRpc, request: QueryCurrentPlanRequest) => Promise<QueryCurrentPlanResponse>;
/**
 ...
 */
export declare const getAppliedPlan: (client: import("@agoric/cosmic-proto/codegen/helper-func-types.js").EndpointOrRpc, request: QueryAppliedPlanRequest) => Promise<QueryAppliedPlanResponse>;
/**
 ...
 */
export declare const getModuleVersions: (client: import("@agoric/cosmic-proto/codegen/helper-func-types.js").EndpointOrRpc, request: QueryModuleVersionsRequest) => Promise<QueryModuleVersionsResponse>;
/**
 ...
 */
export declare const getAuthority: (client: import("@agoric/cosmic-proto/codegen/helper-func-types.js").EndpointOrRpc, request: QueryAuthorityRequest) => Promise<QueryAuthorityResponse>;
