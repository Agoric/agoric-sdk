...
export declare const createRPCQueryClient: ({ rpcEndpoint, }: {
    ...
    agoric: {
        vstorage: {
            data(request: import("@agoric/cosmic-proto/agoric/vstorage/query.js").QueryDataRequest): Promise<import("@agoric/cosmic-proto/agoric/vstorage/query.js").QueryDataResponse>;
            capData(request: import("@agoric/cosmic-proto/agoric/vstorage/query.js").QueryCapDataRequest): Promise<import("@agoric/cosmic-proto/agoric/vstorage/query.js").QueryCapDataResponse>;
            children(request: import("@agoric/cosmic-proto/agoric/vstorage/query.js").QueryChildrenRequest): Promise<import("@agoric/cosmic-proto/agoric/vstorage/query.js").QueryChildrenResponse>;
        };
        vbank: {
            params(request?: import("@agoric/cosmic-proto/agoric/vbank/query.js").QueryParamsRequest): Promise<import("@agoric/cosmic-proto/agoric/vbank/query.js").QueryParamsResponse>;
            state(request?: import("@agoric/cosmic-proto/agoric/vbank/query.js").QueryStateRequest): Promise<import("@agoric/cosmic-proto/agoric/vbank/query.js").QueryStateResponse>;
        };
        swingset: {
            params(request?: import("@agoric/cosmic-proto/agoric/swingset/query.js").QueryParamsRequest): Promise<import("@agoric/cosmic-proto/agoric/swingset/query.js").QueryParamsResponse>;
            egress(request: import("@agoric/cosmic-proto/agoric/swingset/query.js").QueryEgressRequest): Promise<import("@agoric/cosmic-proto/agoric/swingset/query.js").QueryEgressResponse>;
            mailbox(request: import("@agoric/cosmic-proto/agoric/swingset/query.js").QueryMailboxRequest): Promise<import("@agoric/cosmic-proto/agoric/swingset/query.js").QueryMailboxResponse>;
        };
    };
}>;
