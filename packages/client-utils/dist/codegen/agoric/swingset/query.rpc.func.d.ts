 ...
 */
export declare const getEgress: (client: import("@agoric/cosmic-proto/codegen/helper-func-types.js").EndpointOrRpc, request: QueryEgressRequest) => Promise<QueryEgressResponse>;
/**
 ...
 */
export declare const getMailbox: (client: import("@agoric/cosmic-proto/codegen/helper-func-types.js").EndpointOrRpc, request: QueryMailboxRequest) => Promise<QueryMailboxResponse>;
