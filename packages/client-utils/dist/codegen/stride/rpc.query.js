...
export const createRPCQueryClient = async ({ rpcEndpoint, }) => {
    ...
    return {
        stride: {
            staketia: (await import('./staketia/query.rpc.Query.js')).createRpcQueryExtension(client),
            stakeibc: (await import('./stakeibc/query.rpc.Query.js')).createRpcQueryExtension(client),
            stakedym: (await import('./stakedym/query.rpc.Query.js')).createRpcQueryExtension(client),
            records: (await import('./records/query.rpc.Query.js')).createRpcQueryExtension(client),
