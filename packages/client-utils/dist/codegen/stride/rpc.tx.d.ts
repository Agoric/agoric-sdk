...
export declare const createRPCMsgClient: ({ rpc }: {
    ...
    stride: {
        staketia: import("./staketia/tx.rpc.msg.js").MsgClientImpl;
        stakeibc: import("./stakeibc/tx.rpc.msg.js").MsgClientImpl;
        stakedym: import("./stakedym/tx.rpc.msg.js").MsgClientImpl;
    };
    cosmos: {
        vesting: {
