...
export const createRPCQueryClient = async ({ rpcEndpoint, }) => {
    ...
    return {
        ibc: {
            lightclients: {
                wasm: {
                    v1: (await import('./lightclients/wasm/v1/query.rpc.Query.js')).createRpcQueryExtension(client),
                },
            },
            core: {
                connection: {
            ...
            applications: {
                ...
                interchain_accounts: {
                    host: {
                        v1: (await import('./applications/interchain_accounts/host/v1/query.rpc.Query.js')).createRpcQueryExtension(client),
                    },
                    controller: {
                        v1: (await import('./applications/interchain_accounts/controller/v1/query.rpc.Query.js')).createRpcQueryExtension(client),
                    },
                },
            },
        },
