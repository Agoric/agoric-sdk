export const createRPCMsgClient = async ({ rpc }) => ({
    ibc: {
        lightclients: {
            wasm: {
                v1: new (await import('./lightclients/wasm/v1/tx.rpc.msg.js')).MsgClientImpl(rpc),
            },
        },
        core: {
            connection: {
        ...
        applications: {
            ...
            interchain_accounts: {
                host: {
                    v1: new (await import('./applications/interchain_accounts/host/v1/tx.rpc.msg.js')).MsgClientImpl(rpc),
                },
                controller: {
                    v1: new (await import('./applications/interchain_accounts/controller/v1/tx.rpc.msg.js')).MsgClientImpl(rpc),
                },
            },
        },
    },
