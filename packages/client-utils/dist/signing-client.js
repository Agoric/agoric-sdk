...
const agoricRegistryTypes = [
    [
        AgoricMsgs.MsgWalletSpendAction.typeUrl,
        MsgWalletSpendActionType,
    ],
];
export const makeStargateClientKit = async (mnemonic, { prefix = 'agoric', hdPath = `m/44'/564'/0'/0/0`, rpcAddr, connectWithSigner, }) => {
...
//# sourceMappingURL=signing-client.js.map