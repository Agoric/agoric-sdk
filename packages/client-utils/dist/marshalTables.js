...
export const makeClientMarshaller = valToSlot => {
    ...
    const { convertValToSlot, convertSlotToVal } = makeTranslationTable(valToSlot || noNewSlots, synthesizeRemotable);
    return makeMarshal(convertValToSlot, convertSlotToVal, {
        serializeBodyFormat: 'smallcaps',
    });
};
//# sourceMappingURL=marshalTables.js.map