...
export const QueryRequest = {
  ...
  toJSON(message: QueryRequest): JsonSafe<QueryRequest> {
    ...
    message.request !== undefined && (obj.request = message.request ? Any.toJSON(message.request) : undefined);
...
export const QueryResponse = {
  ...
  toJSON(message: QueryResponse): JsonSafe<QueryResponse> {
    ...
    message.reply !== undefined && (obj.reply = message.reply ? Any.toJSON(message.reply) : undefined);
  ...
  fromPartial(object: Partial<QueryResponse>): QueryResponse {
    ...
    message.reply = object.reply !== undefined && object.reply !== null ? Any.fromPartial(object.reply) : undefined;
...
export const QueryResponses = {
  typeUrl: "/agoric.vlocalchain.QueryResponses",
  encode(message: QueryResponses, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
  ...
  fromJSON(object: any): QueryResponses {
    return {
      responses: Array.isArray(object?.responses) ? object.responses.map((e: any) => QueryResponse.fromJSON(e)) : []
    };
  },
