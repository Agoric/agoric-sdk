...
export const GenesisState = {
  ...
  fromJSON(object: any): GenesisState {
    return {
      ...
      swingStoreExportDataHash: isSet(object.swingStoreExportDataHash) ? String(object.swingStoreExportDataHash) : ""
    };
  },
  toJSON(message: GenesisState): JsonSafe<GenesisState> {
    ...
    message.swingStoreExportDataHash !== undefined && (obj.swingStoreExportDataHash = message.swingStoreExportDataHash);
    return obj;
  },
