...
export const createRPCQueryClient = async ({
  ...
  return {
    agoric: {
      swingset: (await import("./swingset/query.rpc.Query.js")).createRpcQueryExtension(client),
      vbank: (await import("./vbank/query.rpc.Query.js")).createRpcQueryExtension(client),
      vstorage: (await import("./vstorage/query.rpc.Query.js")).createRpcQueryExtension(client)
    },
    cosmos: {
      auth: {
