//@ts-nocheck
import { MemberRequest, type MemberRequestSDKType, VoteOption, ProposalExecutorResult, voteOptionFromJSON, voteOptionToJSON, proposalExecutorResultFromJSON, proposalExecutorResultToJSON } from "./types.js";
