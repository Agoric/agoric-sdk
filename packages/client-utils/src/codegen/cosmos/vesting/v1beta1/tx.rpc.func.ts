 ...
 */
export const createPermanentLockedAccount =
  buildTx<MsgCreatePermanentLockedAccount>({
 ...
 */
export const createPeriodicVestingAccount =
  buildTx<MsgCreatePeriodicVestingAccount>({
 ...
 */
export const createClawbackVestingAccount =
  buildTx<MsgCreateClawbackVestingAccount>({
 ...
 */
export const returnGrants = buildTx<MsgReturnGrants>({
  msg: MsgReturnGrants,
});
