...
export const HostZone = {
  ...
  fromJSON(object: any): HostZone {
    return {
      ...
      redemptionsEnabled: isSet(object.redemptionsEnabled) ? Boolean(object.redemptionsEnabled) : false,
  ...
  toJSON(message: HostZone): JsonSafe<HostZone> {
    ...
    message.withdrawalIcaAddress !== undefined && (obj.withdrawalIcaAddress = message.withdrawalIcaAddress);
    message.feeIcaAddress !== undefined && (obj.feeIcaAddress = message.feeIcaAddress);
    message.delegationIcaAddress !== undefined && (obj.delegationIcaAddress = message.delegationIcaAddress);
    message.redemptionIcaAddress !== undefined && (obj.redemptionIcaAddress = message.redemptionIcaAddress);
    message.communityPoolDepositIcaAddress !== undefined && (obj.communityPoolDepositIcaAddress = message.communityPoolDepositIcaAddress);
    message.communityPoolReturnIcaAddress !== undefined && (obj.communityPoolReturnIcaAddress = message.communityPoolReturnIcaAddress);
    message.communityPoolStakeHoldingAddress !== undefined && (obj.communityPoolStakeHoldingAddress = message.communityPoolStakeHoldingAddress);
    message.communityPoolRedeemHoldingAddress !== undefined && (obj.communityPoolRedeemHoldingAddress = message.communityPoolRedeemHoldingAddress);
    ...
    message.redemptionsEnabled !== undefined && (obj.redemptionsEnabled = message.redemptionsEnabled);
    message.communityPoolRebate !== undefined && (obj.communityPoolRebate = message.communityPoolRebate ? CommunityPoolRebate.toJSON(message.communityPoolRebate) : undefined);
