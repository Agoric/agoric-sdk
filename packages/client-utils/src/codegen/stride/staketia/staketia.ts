...
export const HostZone = {
  ...
  fromJSON(object: any): HostZone {
    return {
      ...
      remainingDelegatedBalance: isSet(object.remainingDelegatedBalance) ? String(object.remainingDelegatedBalance) : "",
  ...
  toJSON(message: HostZone): JsonSafe<HostZone> {
    ...
    message.remainingDelegatedBalance !== undefined && (obj.remainingDelegatedBalance = message.remainingDelegatedBalance);
