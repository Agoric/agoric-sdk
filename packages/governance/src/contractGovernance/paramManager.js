 ...
 * @property {(name: string, value: import('@agoric/time/src/types.js').Timestamp) => ParamManagerBuilder} addTimestamp
 * @property {(name: string, value: import('@agoric/time/src/types.js').RelativeTime) => ParamManagerBuilder} addRelativeTime
...
const makeParamManagerBuilder = (publisherKit, zoe) => {
  ...
  /** @type {(name: string, value: import('@agoric/time/src/types.js').Timestamp, builder: ParamManagerBuilder) => ParamManagerBuilder} */
  const addTimestamp = (name, value, builder) => {
    buildCopyParam(name, value, assertTimestamp, ParamTypes.TIMESTAMP);
    return builder;
  };

  /** @type {(name: string, value: import('@agoric/time/src/types.js').RelativeTime, builder: ParamManagerBuilder) => ParamManagerBuilder} */
