 ...
 *   Ratio | string | import('@agoric/time/src/types.js').TimestampRecord |
 *   import('@agoric/time/src/types.js').RelativeTimeRecord | unknown } ParamValue
 */
 ...
 * @property {import('@agoric/time/src/types.js').Timestamp} deadline
 */
 ...
 * @property {(name: string) => import('@agoric/time/src/types.js').TimestampRecord} getTimestamp
 * @property {(name: string) => import('@agoric/time/src/types.js').RelativeTimeRecord} getRelativeTime
 ...
 * @param {import('@agoric/time/src/types.js').Timestamp} deadline
