...
const expectedcontractGovernorStartLog = [
  ...
  'Voter Carol cast a ballot for leave MalleableNumber unchanged.',
  'Voter Dave cast a ballot for change MalleableNumber to "[299792458n]".',
  'Voter Emma cast a ballot for change MalleableNumber to "[299792458n]".',
  '@@ tick:1 @@',
  '@@ tick:2 @@',
  '@@ tick:3 @@',
