...
const expectedBrokenUpdateLog = [
  '=> voter and electorate vats are set up',
  '@@ schedule task for:2, currently: 0 @@',
  'Voter Alice voted for {"noChange":["MalleableNumber","Electorate"]}',
  'Voter Bob voted for {"changes":[{"MalleableNumber":"[42n]"},{"Electorate":{"brand":"[Alleged: Zoe Invitation brand]","value":[{"description":"questionPoser","handle":"[Alleged: InvitationHandle]","installation":"[Alleged: Installation]","instance":"[Alleged: InstanceHandle]"}]}}]}',
  'Voter Carol voted for {"changes":[{"MalleableNumber":"[42n]"},{"Electorate":{"brand":"[Alleged: Zoe Invitation brand]","value":[{"description":"questionPoser","handle":"[Alleged: InvitationHandle]","installation":"[Alleged: Installation]","instance":"[Alleged: InstanceHandle]"}]}}]}',
  'Voter Dave voted for {"changes":[{"MalleableNumber":"[42n]"},{"Electorate":{"brand":"[Alleged: Zoe Invitation brand]","value":[{"description":"questionPoser","handle":"[Alleged: InvitationHandle]","installation":"[Alleged: Installation]","instance":"[Alleged: InstanceHandle]"}]}}]}',
  'Voter Emma voted for {"noChange":["MalleableNumber","Electorate"]}',
  '@@ tick:1 @@',
  '@@ tick:2 @@',
  '&& running a task scheduled for 2. &&',
  'vote outcome: {"changes":[{"MalleableNumber":"[42n]"},{"Electorate":{"brand":"[Alleged: Zoe Invitation brand]","value":[{"description":"questionPoser","handle":"[Alleged: InvitationHandle]","installation":"[Alleged: Installation]","instance":"[Alleged: InstanceHandle]"}]}}]}',
  'Validation complete: true',
