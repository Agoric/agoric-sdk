...
const expectedApiGovernanceLog = [
  ...
  'Voter Bob voted for {"apiMethod":"governanceApi","methodParams":[]}',
  'Voter Carol voted for {"apiMethod":"governanceApi","methodParams":[]}',
  'Voter Dave voted for {"apiMethod":"governanceApi","methodParams":[]}',
  'Voter Emma voted for {"dontInvoke":"governanceApi"}',
  '@@ tick:1 @@',
  '@@ tick:2 @@',
  '&& running a task scheduled for 2. &&',
  'vote outcome: {"apiMethod":"governanceApi","methodParams":[]}',
  'update value: 1',
  'Number after: 1',
];
