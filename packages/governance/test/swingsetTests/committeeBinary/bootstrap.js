 ...
 * @param {import('@agoric/time/src/types.js').Timestamp} closingTime
 * @param {{ electorateFacet: import('../../../src/committee.js').CommitteeElectorateCreatorFacet, installations: Record<string, Installation>, timer: import('@agoric/time/src/types.js').TimerService }} tools
 * @param {*} quorumRule
 */
