...
func replayCmd() *cobra.Command {
	return &cobra.Command{
		Use:   "replay <root-dir>",
		Short: "Replay Agoric transactions",
...
func replayTxs(rootDir string) error {
	...
	agApp := app.NewAgoricApp(
		DefaultController, ctx.Logger, appDB, traceStoreWriter, true, uint(1), map[int64]bool{}, "",
	...
	cc := proxy.NewLocalClientCreator(agApp)
