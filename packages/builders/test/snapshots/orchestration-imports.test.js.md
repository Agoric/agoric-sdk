...
> Snapshot 1
    ...
    @Module {
      ...
      CosmosActionOptionsShape: Object @match:splitRecord {
        payload: [
          {},
          {
      ...
      CosmosQueryOptionsShape: Object @match:splitRecord {
        payload: [
          {},
          {
      ...
      LegacyExecuteEncodedTxOptionsShape: Object @match:splitRecord {
        payload: [
          {},
          {
            extensionOptions: Object @match:arrayOf {
