...
export const portfolioPermissionsFromEIP712 = (
  ...
  const permissions: PortfolioPermissions = harden({
    allocation: hasConstraints ? { instruments } : allocation,
    ...(rebalance !== undefined && { rebalance }),
    ...(claimRewards !== undefined && { claimRewards }),
  });
...
export const portfolioPermissionsToEIP712 = (
  ...
  const { allocation = false, claimRewards } = permissions;
