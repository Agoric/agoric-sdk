...
timeout 3 agoric follow -l :published.psm.IST.ToyUSD.metrics -o jsonlines | tee /root/.agoric/psm_metrics.json
timeout 3 agoric follow -l :published.psm.IST.ToyUSD.governance -o jsonlines | tee /root/.agoric/psm_governance.json
