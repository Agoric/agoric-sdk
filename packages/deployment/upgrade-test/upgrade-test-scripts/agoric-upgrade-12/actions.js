...
import { voteLatestProposalAndWait } from '../lib/commonUpgradeHelpers.js/index.js';
import { CHAINID, GOV1ADDR, VALIDATORADDR } from '../lib/constants.js/index.js';
import { agd, bundleSource } from '../lib/cliHelper.js/index.js';
