...
/**
 * @template {AssetKind} [K=AssetKind]
 * @typedef {import('@endo/marshal').RemotableObject & BrandMethods<K>} Brand
 ...
 * @property {Purse<K, M>} mintRecoveryPurse Useful only to get the recovery set
 *   associated with minted payments that are still live.
 ...
 * @template {AssetKind} [K=AssetKind]
 * @template {Key} [M=Key] member kind, for Amounts that have member values
 * @typedef {import('@endo/marshal').RemotableObject & PurseMethods} Purse
 ...
 * @template {AssetKind} [K=AssetKind]
 * @template {Key} [M=Key] member kind, for Amounts that have member values
 * @typedef {import('@endo/marshal').RemotableObject & PaymentMethods} Payment
 ...
 *   either a payment has the same amount of digital assets it started with, or
 *   it is used up entirely. It is impossible to partially use a payment.
 *
