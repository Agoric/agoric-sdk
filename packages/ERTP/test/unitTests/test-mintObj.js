...
test('mint.mintPayment default natMathHelper', async t => {
...
test('mint.mintPayment strSetMathHelpers', async t => {
...
test('mint.mintPayment setMathHelpers', async t => {
...
test('mint.mintPayment setMathHelpers with invites', async t => {
  const { mint, issuer, amountMath } = makeIssuerKit('items', 'set');
