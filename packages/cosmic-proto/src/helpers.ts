...
import type { TypeUrlProto } from './codegen/typeUrlProto.js';
 ...
 * type with a string.
 */
export type TypedJson<T extends unknown | keyof TypeUrlProto = unknown> =
...
export const typedJson = <T extends keyof TypeUrlProto>(
  typeStr: T,
  obj: TypeUrlProto[T],
) => {
  return {
