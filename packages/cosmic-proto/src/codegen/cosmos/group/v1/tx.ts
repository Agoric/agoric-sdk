...
export const MsgUpdateGroupMembers = {
  ...
  fromAmino(object: MsgUpdateGroupMembersAmino): MsgUpdateGroupMembers {
    ...
    message.memberUpdates =
      object.member_updates?.map(e => Member.fromAmino(e)) || [];
    return message;
  },
...
export const MsgCreateGroupPolicy = {
  ...
  fromAmino(object: MsgCreateGroupPolicyAmino): MsgCreateGroupPolicy {
    ...
    if (
      ...
      message.decisionPolicy = Cosmos_groupDecisionPolicy_FromAmino(
  ...
  toAmino(message: MsgCreateGroupPolicy): MsgCreateGroupPolicyAmino {
    ...
    obj.decision_policy = message.decisionPolicy
      ? Cosmos_groupDecisionPolicy_ToAmino(message.decisionPolicy as Any)
      : undefined;
    return obj;
  },
...
export const Cosmos_groupDecisionPolicy_FromAmino = (
  content: AnyAmino,
): Any => {
  switch (content.type) {
