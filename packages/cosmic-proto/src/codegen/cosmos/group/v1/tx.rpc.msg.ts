...
export class MsgClientImpl implements Msg {
  ...
  updateGroupMembers(
    ...
    return promise.then(data =>
      MsgUpdateGroupMembersResponse.decode(new BinaryReader(data)),
    );
  }
  updateGroupAdmin(
    request: MsgUpdateGroupAdmin,
    ...
    return promise.then(data =>
      MsgUpdateGroupAdminResponse.decode(new BinaryReader(data)),
    );
  }
  updateGroupMetadata(
    request: MsgUpdateGroupMetadata,
    ...
    return promise.then(data =>
      MsgUpdateGroupMetadataResponse.decode(new BinaryReader(data)),
    );
  }
  createGroupPolicy(
    request: MsgCreateGroupPolicy,
    ...
    return promise.then(data =>
      MsgCreateGroupPolicyResponse.decode(new BinaryReader(data)),
    );
  }
  createGroupWithPolicy(
    request: MsgCreateGroupWithPolicy,
    ...
    return promise.then(data =>
      MsgCreateGroupWithPolicyResponse.decode(new BinaryReader(data)),
    );
  }
  updateGroupPolicyAdmin(
    request: MsgUpdateGroupPolicyAdmin,
    ...
    return promise.then(data =>
      MsgUpdateGroupPolicyAdminResponse.decode(new BinaryReader(data)),
    );
  }
  updateGroupPolicyDecisionPolicy(
    request: MsgUpdateGroupPolicyDecisionPolicy,
    ...
    return promise.then(data =>
      MsgUpdateGroupPolicyDecisionPolicyResponse.decode(new BinaryReader(data)),
    );
  }
  updateGroupPolicyMetadata(
    request: MsgUpdateGroupPolicyMetadata,
    ...
    return promise.then(data =>
      MsgUpdateGroupPolicyMetadataResponse.decode(new BinaryReader(data)),
    );
  }
  submitProposal(
    request: MsgSubmitProposal,
  ...
  withdrawProposal(
    ...
    return promise.then(data =>
      MsgWithdrawProposalResponse.decode(new BinaryReader(data)),
    );
  }
  vote(request: MsgVote): Promise<MsgVoteResponse> {
  ...
  leaveGroup(request: MsgLeaveGroup): Promise<MsgLeaveGroupResponse> {
    ...
    return promise.then(data =>
      MsgLeaveGroupResponse.decode(new BinaryReader(data)),
    );
  }
}
