...
export const FileDescriptorSet = {
  ...
  registerTypeUrl() {
    if (
      !GlobalDecoderRegistry.registerExistingTypeUrl(FileDescriptorSet.typeUrl)
    ) {
      return;
    }
...
export const DescriptorProto = {
  ...
  registerTypeUrl() {
    if (
      !GlobalDecoderRegistry.registerExistingTypeUrl(DescriptorProto.typeUrl)
    ) {
      return;
    }
    FieldDescriptorProto.registerTypeUrl();
...
export const MessageOptions = {
  ...
  registerTypeUrl() {
    if (
      !GlobalDecoderRegistry.registerExistingTypeUrl(MessageOptions.typeUrl)
    ) {
      return;
    }
    UninterpretedOption.registerTypeUrl();
...
export const EnumValueOptions = {
  ...
  registerTypeUrl() {
    if (
      !GlobalDecoderRegistry.registerExistingTypeUrl(EnumValueOptions.typeUrl)
    ) {
      return;
    }
    UninterpretedOption.registerTypeUrl();
...
export const ServiceOptions = {
  ...
  registerTypeUrl() {
    if (
      !GlobalDecoderRegistry.registerExistingTypeUrl(ServiceOptions.typeUrl)
    ) {
      return;
    }
    UninterpretedOption.registerTypeUrl();
...
export const SourceCodeInfo = {
  ...
  registerTypeUrl() {
    if (
      !GlobalDecoderRegistry.registerExistingTypeUrl(SourceCodeInfo.typeUrl)
    ) {
      return;
    }
...
export const GeneratedCodeInfo = {
  ...
  registerTypeUrl() {
    if (
      !GlobalDecoderRegistry.registerExistingTypeUrl(GeneratedCodeInfo.typeUrl)
    ) {
      return;
    }
