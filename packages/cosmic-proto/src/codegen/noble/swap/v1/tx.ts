...
export const MsgSwap = {
  ...
  toJSON(message: MsgSwap): JsonSafe<MsgSwap> {
    ...
    message.min !== undefined && (obj.min = message.min ? Coin.toJSON(message.min) : undefined);
    return obj;
  },
...
export const MsgSwapResponse = {
  ...
  toJSON(message: MsgSwapResponse): JsonSafe<MsgSwapResponse> {
    const obj: any = {};
    message.result !== undefined && (obj.result = message.result ? Coin.toJSON(message.result) : undefined);
    if (message.swaps) {
  ...
  fromPartial(object: Partial<MsgSwapResponse>): MsgSwapResponse {
    const message = createBaseMsgSwapResponse();
    message.result = object.result !== undefined && object.result !== null ? Coin.fromPartial(object.result) : undefined;
...
export const MsgPauseByAlgorithm = {
  ...
  fromJSON(object: any): MsgPauseByAlgorithm {
    return {
      signer: isSet(object.signer) ? String(object.signer) : "",
      algorithm: isSet(object.algorithm) ? algorithmFromJSON(object.algorithm) : -1
    };
  },
...
export const MsgPauseByAlgorithmResponse = {
  ...
  fromJSON(object: any): MsgPauseByAlgorithmResponse {
    return {
      pausedPools: Array.isArray(object?.pausedPools) ? object.pausedPools.map((e: any) => BigInt(e.toString())) : []
    };
  },
  toJSON(message: MsgPauseByAlgorithmResponse): JsonSafe<MsgPauseByAlgorithmResponse> {
    const obj: any = {};
    if (message.pausedPools) {
      obj.pausedPools = message.pausedPools.map(e => (e || BigInt(0)).toString());
    } else {
      obj.pausedPools = [];
    }
    return obj;
...
export const MsgUnpauseByAlgorithmResponse = {
  ...
  fromJSON(object: any): MsgUnpauseByAlgorithmResponse {
    return {
      unpausedPools: Array.isArray(object?.unpausedPools) ? object.unpausedPools.map((e: any) => BigInt(e.toString())) : []
    };
  },
  toJSON(message: MsgUnpauseByAlgorithmResponse): JsonSafe<MsgUnpauseByAlgorithmResponse> {
    const obj: any = {};
    if (message.unpausedPools) {
      obj.unpausedPools = message.unpausedPools.map(e => (e || BigInt(0)).toString());
    } else {
      obj.unpausedPools = [];
    }
    return obj;
