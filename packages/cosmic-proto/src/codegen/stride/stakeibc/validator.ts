...
export const Validator = {
  ...
  toJSON(message: Validator): JsonSafe<Validator> {
    ...
    message.slashQueryProgressTracker !== undefined && (obj.slashQueryProgressTracker = message.slashQueryProgressTracker);
    message.slashQueryCheckpoint !== undefined && (obj.slashQueryCheckpoint = message.slashQueryCheckpoint);
    message.sharesToTokensRate !== undefined && (obj.sharesToTokensRate = message.sharesToTokensRate);
    ...
    message.slashQueryInProgress !== undefined && (obj.slashQueryInProgress = message.slashQueryInProgress);
    return obj;
  },
