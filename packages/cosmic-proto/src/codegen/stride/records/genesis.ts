...
export const GenesisState = {
  ...
  toJSON(message: GenesisState): JsonSafe<GenesisState> {
    ...
    message.userRedemptionRecordCount !== undefined && (obj.userRedemptionRecordCount = (message.userRedemptionRecordCount || BigInt(0)).toString());
    ...
    message.depositRecordCount !== undefined && (obj.depositRecordCount = (message.depositRecordCount || BigInt(0)).toString());
