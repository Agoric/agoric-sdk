//@ts-nocheck
import { Params, type ParamsSDKType, Egress, type EgressSDKType, ChunkedArtifact, type ChunkedArtifactSDKType } from "./swingset.js";
...
export const QueryEgressResponse = {
  ...
  toJSON(message: QueryEgressResponse): JsonSafe<QueryEgressResponse> {
    const obj: any = {};
    message.egress !== undefined && (obj.egress = message.egress ? Egress.toJSON(message.egress) : undefined);
    return obj;
  },
...
export const QueryChunkedArtifactStatusRequest = {
  ...
  encode(message: QueryChunkedArtifactStatusRequest, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.chunkedArtifactId !== BigInt(0)) {
      writer.uint32(8).uint64(message.chunkedArtifactId);
    }
    return writer;
  },
  decode(input: BinaryReader | Uint8Array, length?: number): QueryChunkedArtifactStatusRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: QueryChunkedArtifactStatusRequest): JsonSafe<QueryChunkedArtifactStatusRequest> {
    const obj: any = {};
    message.chunkedArtifactId !== undefined && (obj.chunkedArtifactId = (message.chunkedArtifactId || BigInt(0)).toString());
    return obj;
  },
  fromPartial(object: Partial<QueryChunkedArtifactStatusRequest>): QueryChunkedArtifactStatusRequest {
    const message = createBaseQueryChunkedArtifactStatusRequest();
  ...
  fromProtoMsg(message: QueryChunkedArtifactStatusRequestProtoMsg): QueryChunkedArtifactStatusRequest {
  ...
  toProtoMsg(message: QueryChunkedArtifactStatusRequest): QueryChunkedArtifactStatusRequestProtoMsg {
    return {
      typeUrl: "/agoric.swingset.QueryChunkedArtifactStatusRequest",
...
export const QueryChunkedArtifactStatusResponse = {
  ...
  encode(message: QueryChunkedArtifactStatusResponse, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.chunkedArtifactId !== BigInt(0)) {
      writer.uint32(8).uint64(message.chunkedArtifactId);
    }
    if (message.chunkedArtifact !== undefined) {
      ChunkedArtifact.encode(message.chunkedArtifact, writer.uint32(18).fork()).ldelim();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryChunkedArtifactStatusResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: QueryChunkedArtifactStatusResponse): JsonSafe<QueryChunkedArtifactStatusResponse> {
    const obj: any = {};
    message.chunkedArtifactId !== undefined && (obj.chunkedArtifactId = (message.chunkedArtifactId || BigInt(0)).toString());
  ...
  fromPartial(object: Partial<QueryChunkedArtifactStatusResponse>): QueryChunkedArtifactStatusResponse {
    const message = createBaseQueryChunkedArtifactStatusResponse();
    message.chunkedArtifactId = object.chunkedArtifactId !== undefined && object.chunkedArtifactId !== null ? BigInt(object.chunkedArtifactId.toString()) : BigInt(0);
  ...
  fromProtoMsg(message: QueryChunkedArtifactStatusResponseProtoMsg): QueryChunkedArtifactStatusResponse {
  ...
  toProtoMsg(message: QueryChunkedArtifactStatusResponse): QueryChunkedArtifactStatusResponseProtoMsg {
    return {
      typeUrl: "/agoric.swingset.QueryChunkedArtifactStatusResponse",
