 ...
 */
export declare const getValidators: (client: import("../../helper-func-types.js").EndpointOrRpc, request: QueryGetValidatorsRequest) => Promise<QueryGetValidatorsResponse>;
/**
 ...
 */
export declare const getHostZone: (client: import("../../helper-func-types.js").EndpointOrRpc, request: QueryGetHostZoneRequest) => Promise<QueryGetHostZoneResponse>;
/**
 ...
 */
export declare const getHostZoneAll: (client: import("../../helper-func-types.js").EndpointOrRpc, request: QueryAllHostZoneRequest) => Promise<QueryAllHostZoneResponse>;
/**
 ...
 */
export declare const getModuleAddress: (client: import("../../helper-func-types.js").EndpointOrRpc, request: QueryModuleAddressRequest) => Promise<QueryModuleAddressResponse>;
/**
 ...
 */
export declare const getInterchainAccountFromAddress: (client: import("../../helper-func-types.js").EndpointOrRpc, request: QueryInterchainAccountFromAddressRequest) => Promise<QueryInterchainAccountFromAddressResponse>;
/**
 ...
 */
export declare const getEpochTracker: (client: import("../../helper-func-types.js").EndpointOrRpc, request: QueryGetEpochTrackerRequest) => Promise<QueryGetEpochTrackerResponse>;
/**
 ...
 */
export declare const getEpochTrackerAll: (client: import("../../helper-func-types.js").EndpointOrRpc, request: QueryAllEpochTrackerRequest) => Promise<QueryAllEpochTrackerResponse>;
/**
 ...
 */
export declare const getNextPacketSequence: (client: import("../../helper-func-types.js").EndpointOrRpc, request: QueryGetNextPacketSequenceRequest) => Promise<QueryGetNextPacketSequenceResponse>;
/**
 ...
 */
export declare const getAddressUnbondings: (client: import("../../helper-func-types.js").EndpointOrRpc, request: QueryAddressUnbondings) => Promise<QueryAddressUnbondingsResponse>;
/**
 ...
 */
export declare const getAllTradeRoutes: (client: import("../../helper-func-types.js").EndpointOrRpc, request: QueryAllTradeRoutes) => Promise<QueryAllTradeRoutesResponse>;
