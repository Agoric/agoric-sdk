 ...
 */
export declare const getHostZone: (client: import("../../helper-func-types.js").EndpointOrRpc, request: QueryHostZoneRequest) => Promise<QueryHostZoneResponse>;
/**
 ...
 */
export declare const getDelegationRecords: (client: import("../../helper-func-types.js").EndpointOrRpc, request: QueryDelegationRecordsRequest) => Promise<QueryDelegationRecordsResponse>;
/**
 ...
 */
export declare const getUnbondingRecords: (client: import("../../helper-func-types.js").EndpointOrRpc, request: QueryUnbondingRecordsRequest) => Promise<QueryUnbondingRecordsResponse>;
/**
 ...
 */
export declare const getRedemptionRecord: (client: import("../../helper-func-types.js").EndpointOrRpc, request: QueryRedemptionRecordRequest) => Promise<QueryRedemptionRecordResponse>;
/**
 ...
 */
export declare const getRedemptionRecords: (client: import("../../helper-func-types.js").EndpointOrRpc, request: QueryRedemptionRecordsRequest) => Promise<QueryRedemptionRecordsResponse>;
/**
 ...
 */
export declare const getSlashRecords: (client: import("../../helper-func-types.js").EndpointOrRpc, request: QuerySlashRecordsRequest) => Promise<QuerySlashRecordsResponse>;
