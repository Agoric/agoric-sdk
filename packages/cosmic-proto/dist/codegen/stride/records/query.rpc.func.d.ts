 ...
 */
export declare const getUserRedemptionRecord: (client: import("../../helper-func-types.js").EndpointOrRpc, request: QueryGetUserRedemptionRecordRequest) => Promise<QueryGetUserRedemptionRecordResponse>;
/**
 ...
 */
export declare const getUserRedemptionRecordAll: (client: import("../../helper-func-types.js").EndpointOrRpc, request: QueryAllUserRedemptionRecordRequest) => Promise<QueryAllUserRedemptionRecordResponse>;
/**
 ...
 */
export declare const getUserRedemptionRecordForUser: (client: import("../../helper-func-types.js").EndpointOrRpc, request: QueryAllUserRedemptionRecordForUserRequest) => Promise<QueryAllUserRedemptionRecordForUserResponse>;
/**
 ...
 */
export declare const getEpochUnbondingRecord: (client: import("../../helper-func-types.js").EndpointOrRpc, request: QueryGetEpochUnbondingRecordRequest) => Promise<QueryGetEpochUnbondingRecordResponse>;
/**
 ...
 */
export declare const getEpochUnbondingRecordAll: (client: import("../../helper-func-types.js").EndpointOrRpc, request: QueryAllEpochUnbondingRecordRequest) => Promise<QueryAllEpochUnbondingRecordResponse>;
/**
 ...
 */
export declare const getDepositRecord: (client: import("../../helper-func-types.js").EndpointOrRpc, request: QueryGetDepositRecordRequest) => Promise<QueryGetDepositRecordResponse>;
/**
 ...
 */
export declare const getDepositRecordAll: (client: import("../../helper-func-types.js").EndpointOrRpc, request: QueryAllDepositRecordRequest) => Promise<QueryAllDepositRecordResponse>;
/**
 ...
 */
export declare const getDepositRecordByHost: (client: import("../../helper-func-types.js").EndpointOrRpc, request: QueryDepositRecordByHostRequest) => Promise<QueryDepositRecordByHostResponse>;
/**
 ...
 */
export declare const getLSMDeposit: (client: import("../../helper-func-types.js").EndpointOrRpc, request: QueryLSMDepositRequest) => Promise<QueryLSMDepositResponse>;
/**
 ...
 */
export declare const getLSMDeposits: (client: import("../../helper-func-types.js").EndpointOrRpc, request: QueryLSMDepositsRequest) => Promise<QueryLSMDepositsResponse>;
