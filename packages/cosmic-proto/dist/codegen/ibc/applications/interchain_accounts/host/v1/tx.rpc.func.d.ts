 ...
 */
export declare const moduleQuerySafe: (client: import("@interchainjs/cosmos").ISigningClient, signerAddress: string, message: MsgModuleQuerySafe | MsgModuleQuerySafe[], fee: import("../../../../../types.ts").StdFee | "auto", memo: string) => Promise<import("@interchainjs/types").DeliverTxResponse>;
