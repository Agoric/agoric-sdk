 ...
 */
export declare const getInflation: (client: import("../../../helper-func-types.js").EndpointOrRpc, request: QueryInflationRequest) => Promise<QueryInflationResponse>;
/**
 ...
 */
export declare const getAnnualProvisions: (client: import("../../../helper-func-types.js").EndpointOrRpc, request: QueryAnnualProvisionsRequest) => Promise<QueryAnnualProvisionsResponse>;
