...
export interface Proposal {
     ...
     */
    content?: TextProposal | ClientUpdateProposal | UpgradeProposal | SoftwareUpgradeProposal | CancelSoftwareUpgradeProposal | ParameterChangeProposal | CommunityPoolSpendProposal | CommunityPoolSpendProposalWithDeposit | CoreEvalProposal | Any | undefined;
    /**
...
export interface ProposalSDKType {
    proposal_id: bigint;
    content?: TextProposalSDKType | ClientUpdateProposalSDKType | UpgradeProposalSDKType | SoftwareUpgradeProposalSDKType | CancelSoftwareUpgradeProposalSDKType | ParameterChangeProposalSDKType | CommunityPoolSpendProposalSDKType | CommunityPoolSpendProposalWithDepositSDKType | CoreEvalProposalSDKType | AnySDKType | undefined;
    status: ProposalStatus;
