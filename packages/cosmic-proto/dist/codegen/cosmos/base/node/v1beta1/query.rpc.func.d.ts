 ...
 */
export declare const getConfig: (client: import("../../../../helper-func-types.js").EndpointOrRpc, request: ConfigRequest) => Promise<ConfigResponse>;
/**
 ...
 */
export declare const getStatus: (client: import("../../../../helper-func-types.js").EndpointOrRpc, request: StatusRequest) => Promise<StatusResponse>;
