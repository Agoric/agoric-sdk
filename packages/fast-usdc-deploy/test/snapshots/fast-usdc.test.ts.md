...
> See also board marshalling conventions (_to appear_).
    ...
    [
      [
        'published.fastUsdc.txns.0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef',
        {
          status: 'FORWARDED',
        },
      ],
      [
        'published.fastUsdc.txns.0xInvokeTestTxHash100000000000000000000000000000000000000000000000',
        {
          status: 'ADVANCING',
        },
      ],
      [
        'published.fastUsdc.txns.0xInvokeTestTxHash200000000000000000000000000000000000000000000000',
        {
          status: 'ADVANCING',
        },
      ],
      ...
      [
        'published.fastUsdc.txns.0xe81bc6105b60a234c7c50ac17816ebcd5561d366df8bf3be59ff3875527617z9',
        {
          split: {
            ContractFee: {
              brand: Object @Alleged: USDC brand {},
