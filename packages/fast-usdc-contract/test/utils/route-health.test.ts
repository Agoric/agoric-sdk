...
test('makeRouteHealth initial state', t => {
  ...
  t.true(health.isWorking('route1'), 'Route should be ready initially');
});
...
test('makeRouteHealth noteSuccess resets count', t => {
  ...
  health.noteFailure('route1');
  health.noteFailure('route1');
  t.true(health.isWorking('route1'), 'Route should be ready before success');
  health.noteSuccess('route1');
  t.true(health.isWorking('route1'), 'Route should be ready after success');
