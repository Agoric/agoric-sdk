      ...
      function makeChainBundler(vats, timerDevice) {
        return harden({
          async createUserBundle(nickname, jackpot) {
            ...
            const simolean = E(vats.mints).getNewPurse('simolean', 'Simolean purse');
        ...
        async bootstrap(argv, vats, devices) {
          ...
          if (ROLES.chain || ROLES.one_chain) {
            ...
            await E(vats.http).setPresences(
              ...
              await createLocalBundle(vats, bundle.contractHost, bundle.zoe, bundle.registrar),
            );
            ...
            await setupCommandDevice(vats.http, devices.command, {client: true});
            const { purses, bundle } = await makeChainBundler(vats, devices.timer)
