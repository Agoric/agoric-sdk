  ...
  return helpers.makeLiveSlots(
    ...
    (E, D) => {
      ...
      async function addLocalTimer(vats, devices) {
        ...
        return E(vats.timer).createTimerHandler();
      }
      ...
      function makeBundler(contractHost, vats) {
        return harden({
          async createDemoBundle(nickname) {
            ...
            const chainTimerHandler = await E(vats.timer).createTimerHandler();
      ...
      return harden({
        async bootstrap(argv, vats, devices) {
          ...
          if (ROLES.chain || ROLES.one_chain) {
            ...
            const localTimerHandler = await addLocalTimer(vats, devices);
            await addRemote(GCI);
