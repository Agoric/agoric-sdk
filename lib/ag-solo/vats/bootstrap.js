...
export default function setup(syscall, state, helpers) {
  ...
  console.log(`HTTP registerCommandHandler ${vats.http}`);
      ...
      async function setupWalletVat(vats, devices) {
  console.log(`WALLET registerCommandHandler ${vats.http}`);
      ...
      async function fillTwoPurses(moolahPurseName, simoleanPurseName) {
      ...
      return harden({
        async bootstrap(argv, vats, devices) {
          ...
          if (ROLES.chain || ROLES.one_chain) {
            ...
            await setupWalletVat(vats, devices);
  ...
  console.log(`S2client registerCommandHandler ${vats.http}`);
            ...
            await setupCommandDevice(vats, devices, { client: true });
  console.log(`S3 registerCommandHandler ${vats.http}`);
            await E(vats.http).registerCommandHandler(vats.exchange);
            await setupWalletVat(vats, devices);
          } else {
