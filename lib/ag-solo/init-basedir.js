...
export default function initBasedir(basedir, webport, webhost) {
  ...
  fs.symlinkSync(path.resolve(here, '../../node_modules'), path.join(basedir, 'node_modules'));
