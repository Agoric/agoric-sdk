...
export async function launch() {
  ...
  async function sdkReady(action) {
    ...
    const { controller, inbound, mb, mbs } = await buildSwingset(withSES, oldState, VATS_DIR);
    ...
    function saveState() {
      ...
      console.log(`checkpointed kernel state: k: ${kernelStateData.length}, m: ${mailboxStateData.length}`);
    }
