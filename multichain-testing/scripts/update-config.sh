...
# sed -i -e "s#halt-height = 0#halt-height = 5#g" $CHAIN_DIR/config/app.toml
...
curl -L https://storage.googleapis.com/agoric-snapshots-public/starship-agoric/agoric-snapshot.tar.gz -o /tmp/agoric-snapshot.tar.gz
