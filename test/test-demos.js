...
async function main(withSESflags, basedir, argv) {
  for (const withSES of withSESflags) {
...
test('run encouragementBot Demo', async t => {
  const dump = await main([true, false], 'demo/encouragementBot', []);
...
test('run encouragementBotComms Demo', async t => {
  const dump = await main([true, false], 'demo/encouragementBotComms', []);
  t.deepEquals(dump.log, [
    '=> setup called',
...
test('run contractHost Demo --mint', async t => {
  const dump = await main([true, false], 'demo/contractHost', ['mint']);
  t.deepEquals(dump.log, [
    '=> setup called',
...
test('run contractHost Demo --trivial', async t => {
  const dump = await main([true, false], 'demo/contractHost', ['trivial']);
  t.deepEquals(dump.log, [
    '=> setup called',
...
test('run contractHost Demo --alice-first', async t => {
  const dump = await main([true, false], 'demo/contractHost', ['alice-first']);
  t.deepEquals(dump.log, [
    '=> setup called',
...
test('run contractHost Demo --bob-first', async t => {
  const dump = await main([true, false], 'demo/contractHost', ['bob-first']);
  t.deepEquals(dump.log, [
    '=> setup called',
...
test('run contractHost Demo --covered-call', async t => {
  const dump = await main([true, false], 'demo/contractHost', ['covered-call']);
  t.deepEquals(dump.log, [
    '=> setup called',
...
test('run contractHost Demo --covered-call-sale', async t => {
  const dump = await main([true, false], 'demo/contractHost', ['covered-call-sale']);
  t.deepEquals(dump.log, [
    '=> setup called',
    '++ bob.offerAliceOption starting',
