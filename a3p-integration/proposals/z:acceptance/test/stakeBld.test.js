...
test('basic', async t => {
  ...
  await agdWalletUtils.broadcastBridgeAction(GOV1ADDR, {
    ...
    offer: {
      ...
      proposal: {
        give: {
          In: { brand: BLDBrand, value: BigInt(BLD_DELEGATION) },
        },
      },
    },
  });
  ...
  await agdWalletUtils.broadcastBridgeAction(GOV1ADDR, {
    ...
    offer: {
      ...
      invitationSpec: {
        ...
        invitationArgs: [
          VALIDATOR_ADDRESS,
          { brand: BLDBrand, value: BigInt(BLD_DELEGATION) },
        ],
      },
      proposal: {
        give: {
  ...
  await agdWalletUtils.broadcastBridgeAction(GOV1ADDR, {
    ...
    offer: {
      ...
      invitationSpec: {
        ...
        invitationArgs: [
          VALIDATOR_ADDRESS,
          { brand: brand.BLD, value: BigInt(BLD_DELEGATION / 2) },
        ],
      },
      proposal: {},
    },
  ...
  //   balance: { amount: String(BLD_DELEGATION / 2), denom: BLD_COIN_DENOM },
  // });
});
