...
test.serial(
  ...
  async t => {
    ...
    t.truthy(opened.accountIdByChain.agoric, 'Agoric LCA was provisioned');
    t.false(
      'noble' in opened.accountIdByChain,
      'Noble ICA was not provisioned',
    );
    t.false(
      'noble' in (opened.accountStateByChain || {}),
      'Noble provisioning did not begin during open',
    );
    ...
    t.true(
      ...
      'Noble provisioning used the configured Agoric-to-Noble connection',
    );
